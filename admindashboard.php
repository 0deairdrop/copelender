...
<html lang="en" dir="ltr">
	...
	//$isAdmin = getLoggedInUserDetailsByKey('isadmin');
	$isAdmin = 1;
	$rs = Src\Module\Dashboard\DashboardFunctions::getUserDashboardData($isAdmin);
			...
			<div class="geex-content">
				<div class="geex-content__header">
					<div class="geex-content__header__content">
						...
						<p class="geex-content__header__subtitle">Welcome to <?= APP_NAME ?> Admin Dashboard</p>
					</div> 
				...
				<div class="geex-content__wrapper">
							...
							<div class="geex-content__section__header">
								...
								<div class="geex-content__section__header__content-part">
									<ul class="nav nav-tabs geex-transaction-tab" id="geex-transaction-tab" role="tablist">
										...
										<li class="nav-item" role="presentation">
											<button class="nav-link" id="transaction-upcoming-tab" data-bs-toggle="tab" data-bs-target="#transaction-upcoming-content" type="button" role="tab" aria-controls="transaction-upcoming-content" aria-selected="false">Incoming Repayments</button>
										</li>
										<li class="nav-item" role="presentation">
											<button class="nav-link" id="transaction-request-tab" data-bs-toggle="tab" data-bs-target="#transaction-credits-content" type="button" role="tab" aria-controls="transaction-credits-content" aria-selected="false">Amount Disbursed</button>
										</li>
										<li class="nav-item" role="presentation">
											<button class="nav-link" id="transaction-request-tab" data-bs-toggle="tab" data-bs-target="#transaction-debits-content" type="button" role="tab" aria-controls="transaction-debits-content" aria-selected="false">Amount Recovered</button>
										</li>
									</ul>
								</div>
							</div>
					...
					<?php 
					// SIDE BAR
						require_once 'common/admin/sidebar.php'; 
					?>
				</div>
